...
async function processArtistBios() {
  ...
  for (const file of jsonFiles) {
    try {
      ...
      const prompt = `What genres of electronic music does the artist named ${name} play? Please sort the genres from most likely to least likely if possible. Please do use outside knowledge, but I've also included a bio below to help. 
